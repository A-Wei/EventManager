...
RSpec.describe 'User resets their password', type: :system do
  context 'when user clicks on "forget password"' do
    context 'when the submitted email exist and user clicks on "reset password link" in email' do
      context 'when token and email are match in the link' do
        ...
        it "show a 'password can't be blank' error if the new password is blank" do
          user = create(:user)
          new_password = ''
        ...
        it "show a 'password too short' error if the new password is too short" do
          user = create(:user)
          new_password = '12345'
        ...
        it "show a 'password doesn't math' error if the passwords does't match" do
          user = create(:user)
          new_password = 'new_password'
